...
function frNavigation() {
    ...
    frBlockRegions = new NBlock(ST_REGION,ST_REGION,
	                        {
	                            dataURL: locationFloodingData,
	                            fields:[
    ...
    frBlockBreaches = new NBlock(ST_BREACH,ST_BREACH,
	                         {
	                             dataURL:locationFloodingData,
	                             fields:[
    ...
    frBlockScenarios = new NBlock(ST_SCENARIO,ST_SCENARIO,
	                          {
	                              dataURL: locationFloodingData,
	                              fields:[
    ...
    frBlockResults = new NBlock( ST_RESULT, ST_RESULT,
	                         { //datasource
	                             dataURL: locationFloodingData,
	                             fields:[
	                                 {name:"id", primaryKey:true, hidden:true, type:"integer"},
