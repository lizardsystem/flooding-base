...
NLegendInfoWindow.prototype.addLegendSection = function(legendSection){
    if (this.legendStack.getSectionNumber("section_" + legendSection.id)<0) {
    	console.log('adding legend section with id=' + legendSection.id + ' and title=' + legendSection.title);    	
		this.legendStack.addSection({ID:"section_" + legendSection.id , title: legendSection.title, canCollapse: true, expanded: legendSection.initialExpanded, items: [legendSection.pane], overflow:'visible'});
...
NLegendInfoWindow.prototype.removeLegendSection = function(legendSection){
    console.log('removing legend section with id=' + legendSection.id + ' and title=' + legendSection.title);
