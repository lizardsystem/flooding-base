...
);isc.evalBoundary;isc.B.push(isc.A.recordHasAllKeys=function(_1){var _2=this.getPrimaryKeyFields();for(var _3 in _2){if(_1[_3]==null)return false}
return true}
...
,isc.A.canQueueRequest=function(_1){if(_1.ignoreTimeout)_1.sendNoQueue=true;var _2=_1.transport;if(_1.directSubmit||_1.downloadResult||_1.target){if(_1.transport!="hiddenFrame"){if(_2){this.logWarn("request specified explicit transport: "+_2+", but other settings (directSubmit, downloadResult, or"+" target) mandate hiddenFrame transport, switching transport"+" to hiddenFrame and submitting without queueing")}
...
_3.sendTime=isc.timeStamp();_3.changed();_3.callback="isc.RPCManager.performTransactionReply(transactionNum,results,wd)";if(_4.directSubmit){isc.Comm.generateJSCallback(_3);var _13=_4.submitForm;var _14=_13.getForm();if(_13.getItem("_transaction")!=null&&isc.isA.HiddenItem(_13.getItem("_transaction")))
{_13.setValue("_transaction",this.serializeTransaction(_3));this.logInfo("Direct submit assigning request data to hidden field instead of"+" submitting as GET request");_13.setAction(this.addParamsToURL(_2,_7))}else{if(_4.useSimpleHttp){_13.setAction(this.addParamsToURL(_2,_7));_3.$387=true}else{_13.setAction(this.transactionAsGetRequest(_3,null,_7))}}
this.$39a(_3);if(_4.target){if(_4.target!=window)_14.target=_4.target;_13.submitForm()}else{var _15=isc.Comm.getTargetableFrame(_4.prompt);_14.target=_15.getName();_3.$ch=_15;_15.draw(_13.getID()+".submitForm()")}}else if(_4.downloadResult){if(!window.name)window.name=isc.timeStamp();var _16=_3.download_filename;if(_4.downloadToNewWindow==false||(_4.downloadToNewWindow==null&&_4.exportFilename)){var _16=window.name}
if(_4.$38j){this.clearTransaction(_3);_3.transactionRequest=this.transactionAsGetRequest(_3,_2,_7);return _3.transactionRequest}
var _10=isc.addProperties(_7,{_transaction:this.serializeTransaction(_3),protocolVersion:"1.0"});_3.$387=true;this.$39a(_3);_3.$ch=isc.Comm.sendHiddenFrame({URL:_2,httpMethod:_4.httpMethod,httpHeaders:_4.httpHeaders,contentType:_4.contentType,fields:_10,target:_16,transactionNum:_3.transactionNum,transaction:_3})}else{var _10=_7;var _17=_3.transport,_18="send"+(_17.substring(0,1).toUpperCase())+_17.substring(1);if(isc.Comm[_18]==null){this.logWarn("Attempt to send transaction with specified transport '"+_3.transport+"' failed - unsupported transaction type.");return}
this.$39a(_3);isc.RPCManager.$410.push(_3.transactionNum);_3.transactionRequest=isc.Comm[_18]({URL:_2,httpMethod:_4.httpMethod,contentType:_4.contentType,httpHeaders:_4.httpHeaders,bypassCache:_4.bypassCache,data:_4.useSimpleHttp?_4.data:null,fields:_10,target:_4.target,callbackParam:_4.callbackParam,transport:_3.transport,blocking:_4.blocking,useSimpleHttp:_4.useSimpleHttp,transactionNum:_3.transactionNum,transaction:_3})}
return _4}
...
if(_2.allClientOnly){_2.results={status:0}}else{var _4=_2.results?_2.results.indexOf(this.$381):-1;_3=_4!=-1;if(_3){var _5=_2.results;_5=this.$455(_5);try{_2.results=eval(_5)}catch(e){this.logWarn("Error evaling structured RPC response: "+e+" response text: "+_5)}}}
...
var _4=_2[0].dsData;eval(_4);var _5=isc.DS.get(_3);var _6=isc.DataSource.$37s;for(var i=0;i<_6[_3].length;i++){isc.DataSource.logInfo("calling registered callback: "+(_6[_3])[i]);this.fireCallback(_6[_3][i],"ds",[_5],_5)}
delete _6[_3]}
...
);isc.B._maxIndex=isc.C+5;isc.A=isc.Canvas;isc.A.$40e={width:8,height:8,overflow:"hidden",backgroundColor:"black",canDrag:true,canDragResize:true,getEventEdge:function(){return this.edge},autoDraw:false};isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.$40f=function(){var _1=isc.Canvas.getInstanceProperty("edgeCursorMap"),_2={};for(var _3 in _1){_2[_3]=isc.Canvas.create({ID:"isc_resizeThumb_"+_3,edge:_3},this.$40e)}
isc.Canvas.$40g=_2}
,isc.A.showResizeThumbs=function(_1){if(!_1)return;if(!isc.Canvas.$40g)isc.Canvas.$40f();var _2=isc.Canvas.$40e.width,_3=isc.Canvas.$40g;var _4=_1.getPageRect(),_5=_4[0],_6=_4[1],_7=_4[2],_8=_4[3],_9=_5+(_7/ 2)-(_2/ 2),_10=_6+(_8/ 2)-(_2/ 2);_3.T.moveTo(_9,_6-_2);_3.B.moveTo(_9,_6+_8);_3.L.moveTo(_5-_2,_10);_3.R.moveTo(_5+_7,_10);_3.TL.moveTo(_5-_2,_6-_2);_3.TR.moveTo(_5+_7,_6-_2);_3.BL.moveTo(_5-_2,_6+_8);_3.BR.moveTo(_5+_7,_6+_8);for(var _11 in _3){var _12=_3[_11];_12.dragTarget=_1;_12.show()}
this.$rl=_1}
,isc.A.hideResizeThumbs=function(){var _1=this.$40g;for(var _2 in _1){_1[_2].hide()}
this.$rl=null}
);isc.B._maxIndex=isc.C+3;isc.A=isc.Canvas.getPrototype();isc.A.editMaskDefaults={draw:function(){this.Super("draw",arguments);this.observe(this.masterElement,"setZIndex","observer.moveAbove(observed)");isc.Canvas.showResizeThumbs(this);this.observe(this.masterElement,"setPrompt","observer.setPrompt(observed.prompt)");return this},hide:function(){this.Super("hide",arguments);if(isc.Canvas.$rl==this)isc.Canvas.hideResizeThumbs()},bringToFront:function(){},mouseDown:function(){this.Super("mouseDown",arguments);return isc.EH.STOP_BUBBLING},mouseUp:function(){this.Super("mouseUp",arguments);return isc.EH.STOP_BUBBLING},click:function(){isc.Canvas.showResizeThumbs(this);return isc.EH.STOP_BUBBLING},doubleClick:function(){this.$jr.bringToFront();return this.click()},canDrag:true,canDragReposition:true,setDragTracker:function(){return isc.EH.STOP_BUBBLING},moved:function(){this.Super("moved",arguments);var _1=this.masterElement;if(_1){var _2=this.getOffsetLeft()-_1.getLeft();var _3=this.getOffsetTop()-_1.getTop();this.$ns=false;_1.moveTo(this.getOffsetLeft(),this.getOffsetTop());this.$ns=true;var _4=this.parentElement.selectedComponents;if(_4.length>0&&_4.contains(this.$jr)){for(var i=0;i<_4.length;i++){if(_4[i]._eventMask!=this){_4[i].moveBy(_2,_3)}}}}
...
isc.Canvas.showResizeThumbs(this);this.$40h=false},showContextMenu:function(){var _1;if(this.parentElement.selectedComponents.length>0){_1=this.SelectionAreaMenuItems}else{_1=this.standardMenuItems.duplicate();if(this.masterElement.editMenuItems!=null){_1.addList(this.masterElement.editMenuItems)}}
if(!this.contextMenu)this.contextMenu=isc.Menu.create({});this.contextMenu.setData(_1);this.contextMenu.showContextMenu(this.masterElement);return false},standardMenuItems:[{title:"Remove",click:"target.destroy()"},{title:"Bring to Front",click:"target.bringToFront()"},{title:"Send to Back",click:"target.sendToBack()"}],SelectionAreaMenuItems:[{title:"Remove Selected Items",click:"target.parentElement.removeSelection(target)"}]};isc.A=isc.Canvas.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setEditingMode=function(_1){this.setEditMode(_1)}
,isc.A.setEditMode=function(_1){if(_1==null)_1=true;if(this.editingOn==_1)return;this.editingOn=_1;if(this.editingOn){this.showEditMask()}else{this.hideEditMask()}}
...
var _3=isc.addProperties({},this.editMaskDefaults,this.editMask,{keepInParentRect:this.keepInParentRect},_2);this.$40i=isc.EH.makeEventMask(this,_3)}
...
,isc.A.hideEditMask=function(){this.$40i.hide()}
);isc.B._maxIndex=isc.C+4;isc.A=isc.Class.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSchema=function(){return isc.DS.get(this.schemaName||this.Class)}
...
);isc.B._maxIndex=isc.C+2;isc.ClassFactory.defineInterface("EditContext");isc.EditContext.addInterfaceMethods({getEditComponents:function(){return this.editComponents},getEditDataSource:function(_1){return isc.DataSource.getDataSource(_1.editDataSource||_1.Class||this.editDataSource)},$40l:function(_1){var _2=[];_2.addList(_1.baseEditFields);_2.addList(_1.editFields);for(var i=0;i<_2.length;i++){var _4=_2[i];if(_4.visible==null)_4.visible=true}
...
return _2}});isc.ClassFactory.defineInterface("Palette");isc.Palette.addInterfaceMethods({makeNewComponent:function(_1){if(!_1)_1=this.getDragData();if(isc.isAn.Array(_1))_1=_1[0];var _2=_1.className||_1.type;var _3={type:_2,_constructor:_2,icon:_1.icon,iconSize:_1.iconSize,showDropIcon:_1.showDropIcon};var _4=_1.defaults;_3.ID=_1.ID||(_4?isc.DS.getAutoId(_4):null);if(_1.loadData){_3.loadData=_1.loadData}else if(_1.liveObject){var _5=_1.liveObject;if(isc.isA.String(_5))_5=window[_5];_3.liveObject=_5}else{_3=this.createLiveObject(_1,_3)}
...
var _5=(isc.isAn.Array(_1)?_1[0]:_1);_5.dropped=true;this.logInfo("sourceWidget is a Palette, dropped node of type: "+_5.type," editing");if(_4==this)this.removeComponent(_5,_2,_3);this.addComponent(_5,_2,_3)}
,isc.A.addComponent=function(_1,_2,_3){if(_1.loadData&&!_1.isLoaded){var _4=this;_1.loadData(_1,_2,this,function(_12){_12=_12||_1
_12.isLoaded=true;_12.dropped=_1.dropped;_4.addComponent(_12,_2,_3)});return}
if(_2==null)_2=this.data.getRoot();var _5=this.getLiveObject(_2);this.logInfo("addComponent will add newNode of type: "+_1.type+" to: "+this.echoLeaf(_5),"editing");var _6=isc.DS.getObjectField(_5,_1.type),_7=isc.DS.getSchemaField(_5,_6);if(!_7){this.logWarn("can't addComponent: can't find a field in parent: "+_5+" for a new child of type: "+_1.type+", newNode is: "+this.echo(_1));return}
if(!_7.multiple){var _8=isc.DS.getChildObject(_5,_1.type);if(_8){var _9=this.data.getChildren(_2).find("ID",isc.DS.getAutoId(_8));this.logWarn("destroying existing child: "+this.echoLeaf(_8)+" in singular field: "+_6);this.data.remove(_9);if(isc.isA.Class(_8)&&!isc.isA.DataSource(_8))_8.destroy()}}
...
var _11=isc.DS.addChildObject(_5,_1.type,_10,_3);if(!_11){this.logWarn("addChildObject failed, returning");return}
_1.liveObject=isc.DS.getChildObject(_5,_1.type,isc.DS.getAutoId(_1.initData));this.logDebug("for new node: "+this.echoLeaf(_1)+" liveObject is now: "+this.echoLeaf(_1.liveObject),"editing");if(_1.liveObject==null){this.logWarn("wasn't able to retrieve live object after adding node of type: "+_1.type+" to liveParent: "+_5+", does liveParent have an appropriate getter() method?")}
this.data.add(_1,_2,_3);this.data.openFolder(_1);this.logInfo("added node "+this.echoLeaf(_1)+" to EditTree at path: "+this.getData().getPath(_1)+" with live object: "+this.echoLeaf(_1.liveObject),"editing");return _1}
