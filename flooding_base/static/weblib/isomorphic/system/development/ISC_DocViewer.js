...
,isc.A.lookupValue=function(_1){if(!_1)return;var _2;if(_1.contains(".")){var _3=_1.split(".");var _4=_3[0];var _5=_3[1];var _6=isc.ClassFactory.getClass(_4);if(this.nativeClasses.contains(_4))_6=eval(_4);if(_3.length==2&&_6){_2=_6[_5];var _7;if(_2===_7){this.logWarn("attribute: "+_1+" evals to undefined");return"undefined"}
...
,isc.A.docDataAvailable=function(){isc.clearPrompt();var _1=false;if(this.topic){this.showTopic(this.topic);_1=true}
