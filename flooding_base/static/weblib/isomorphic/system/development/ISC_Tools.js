...
if(!_9)return _3;var _12=isc.getKeys(_8),_13=_4.getGroups(),_14=[];if(_13!=null){for(var i=0;i<_13.length;i++){var _15=_12.indexOf(_13[i]);if(_15==-1)continue;_12.removeAt(_15);_14.add(_13[i])}
_14.addList(_12)}else{_14=_12}
var _15=_14.indexOf("other");if(_15!=-1){_14.removeAt(_15);_14.add("other")}
_1=[];for(var i=0;i<_14.length;i++){var _11=_14[i],_16=_8[_11],_17=isc.jsdoc.getGroupItem(_11),_18=_17&&_17.title?_17.title:_11.substring(0,1).toLocaleUpperCase()+_11.substring(1);_1[_1.length]={editorType:"GroupItem",defaultValue:_18,sectionExpanded:(i<this.initialGroups),items:_16}}
return _1}
...
this.Super("nextPage")}
,isc.A.enterPickOperationPage=function(_1){var _2=this.dsTypePicker.getValue("dsType");if(!this.servicePicker)this.setUpPickOperationPage(_1);this.nextButton.setDisabled(this.operationPicker.getSelectedRecord()==null)}
