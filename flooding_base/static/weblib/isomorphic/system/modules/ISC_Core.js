...
_2.x=parseInt(_1.x);_2.y=parseInt(_1.y);if(_3){_2.x+=isc.Page.getScrollLeft();_2.y+=isc.Page.getScrollTop()}}else{if(_2.eventType!=this.MOUSE_WHEEL){var _3=!isc.Browser.isMoz||(isc.Browser.geckoVersion<20080529);_2.x=parseInt(_1.clientX)+(_3?isc.Page.getScrollLeft():0);_2.y=parseInt(_1.clientY)+(_3?isc.Page.getScrollTop():0)}}
...
{return _1.getBoundingClientRect().left}else if((this.useBoxObjectAPI||(this.useBoxObjectAPISelectively&&isc.$54j))&&isc.Browser.geckoVersion>20061010&&!isc.Browser.isCamino&&document.getBoxObjectFor!=null)
{var _5=this.getDocument().getBoxObjectFor(_1);if(_5){var _6=_5.x-this.getLeftMargin(),_2=this.parentElement;while(_2){_6+=_2.getScrollLeft();_2=_2.parentElement}}}}
return this.$s4()}
...
if(isc.Browser.isMoz){if(this.useClientRectAPI&&isc.Browser.geckoVersion>20071109&&_1.getBoundingClientRect!=null)
{return _1.getBoundingClientRect().top}else if((this.useBoxObjectAPI||(this.useBoxObjectAPISelectively&&isc.$54j))&&isc.Browser.geckoVersion>20061010&&!isc.Browser.isCamino&&document.getBoxObjectFor!=null)
{var _3=this.getDocument().getBoxObjectFor(_1);if(_3){var _4=_3.y-this.getTopMargin(),_2=this.parentElement;while(_2){_4+=_2.getScrollTop();_2=_2.parentElement}}}}
return this.$s5()}
...
);isc.evalBoundary;isc.B.push(isc.A.$we=function(_1,_2){if(this.$nw)this.$wd(this.$nw.part,"hover",_1,_2)}
