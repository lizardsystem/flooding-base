...
function NWMSOverlay(id,name,options) {
    ...
    this.framesFromRequest = options.getFramesFromRequest || true;
...
/*** Destroys the the object, such that it can be removed by the garbage collector ***/
...
NWMSOverlay.prototype.redraw= function(){
	if (this.isInit) {
    	//this.layer.mergeNewParams(this.framesRequestParams);
