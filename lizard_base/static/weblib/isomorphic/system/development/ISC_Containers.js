...
,isc.A.makeButton=function(_1,_2,_3,_4,_5){var _6=this.parentElement.canCloseTab(_1);if(_6){_1.icon=(_1.closeIcon||this.parentElement.closeTabIcon);_1.iconOrientation=isc.Page.isRTL()?"left":"right";_1.iconAlign=_1.iconOrientation}
...
return}
this.Super("$6b",arguments);if(this.$6g!=null&&!this.$6g.selected){this.selectTab(this.$6g)}}
...
,isc.A.returnValue=function(_1){if(this.isVisible())this.hide();if(this.callback)this.fireCallback(this.callback,"value",[_1]);return _1}
,isc.A.show=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;if(this.isModal){if(this.topElement!=null){this.logWarn("Window specified with 'isModal' set to true, but this window has a "+"parentElement. Only top level Windows can be shown modally.");this.isModal=false}else{this.showClickMask(this.getID()+(this.dismissOnOutsideClick?".closeClick()":".flash()"),false,[this]);this.makeModalMask()}}
if(this.shouldDismissOnEscape())this.$42r();if(this.autoCenter&&!this.parentElement){this.$7j=true;this.moveTo(-1000,-1000);this.$7j=false}
...
,isc.A.$42r=function(){this.$42s=true;isc.Page.registerKey("Escape",this.getID()+".handleEscape()",this)}
,isc.A.$42t=function(){isc.Page.unregisterKey("Escape",this);this.$42s=false}
...
,isc.A.hide=function(_1,_2,_3,_4){if(this.$7k)isc.Animation.finishAnimation(this.$7k);this.invokeSuper(isc.Window,"hide",_1,_2,_3,_4);if(this.isDrawn()&&this.isModal){this.hideClickMask();this.hideModalMask()}
if(this.$42s)this.$42t()}
,isc.A.parentVisibilityChanged=function(){if(this.shouldDismissOnEscape()){if(this.isVisible())this.$42r()}else if(this.$42s){this.$42t()}}
,isc.A.clear=function(_1,_2,_3,_4){if(this.$7k)isc.Animation.finishAnimation(this.$7k);this.invokeSuper(isc.Window,"clear",_1,_2,_3,_4);if(this.isVisible()&&this.isModal){this.hideClickMask();this.hideModalMask()}
if(this.isVisible()&&this.$42s)this.$42t()}
...
,isc.A.setTabTitle=function(_1,_2){this.getTab(_1).setTitle(_2)}
,isc.A.enableTab=function(_1){this.setTabDisabled(_1,false)}
,isc.A.disableTab=function(_1){this.setTabDisabled(_1,true)}
,isc.A.setTabDisabled=function(_1,_2){var _1=this.getTab(_1);if(_1){_1.setDisabled(_2);var _3=_1.pane;if(_3){if(isc.isA.Canvas(_3))_3.setDisabled(_2);else _3.disabled=_2}}}
...
this._tabBar.addTabs(_1,_2);if(this.$8d!=null){this.$8d.destroy();delete this.$8d}
this.delayCall("fixLayout");if(_4){this.selectTab(0)}else{this.selectedTab=this.getTabNumber(_3)}
return _2}
,isc.A.removeTab=function(_1,_2){return this.removeTabs(_1,_2)}
,isc.A.removeTabs=function(_1,_2){if(!isc.isAn.Array(_1))_1=[_1];_1=this.map("getTab",_1);var _3=false,_4=this.getSelectedTab();for(var i=0;i<_1.length;i++){var _6=_1[i],_7=this.getTabNumber(_6),_8=this.tabs[_7];if(_8==_4)_3=true;this.tabs.removeAt(_7);var _9=_8.pane;if(_9&&_9.parentElement==this.paneContainer){this.paneContainer.removeChild(_9);if(!_2&&this.destroyPanes!==false)_9.destroy()}
this._tabBar.removeTabs(_6)}
if(_3&&this.tabs.length>0)this.selectTab(0);if(this.$8d!=null){this.$8d.destroy();delete this.$8d}
...
,isc.A.$52a=function(_1){var _2=this.canCloseTab(_1);if(_2){this.removeTab(_1);return false}else return this.tabIconClick(_1)}
,isc.A.closeClick=function(_1){this.removeTab(_1)}
,isc.A.tabIconClick=function(_1){var _2=_1.icon;if(_2&&_2.click)return this.fireCallback(_2.click,'tab',[_1])}
...
var _5=this.symmetricScroller?"back":this.tabBarPosition+"_back",_6=this.symmetricScroller?"forward":this.tabBarPosition+"_forward";this.scroller=isc.StretchImgButton.create({noDoubleClicks:true,tabSet:this,vertical:_2,width:_2?(this.tabBarThickness-this._tabBar.baseLineThickness):(2*_3),height:_2?(2*_3):(this.tabBarThickness-this._tabBar.baseLineThickness),items:[{name:_5,width:_2?null:_3,height:_2?_3:null},{name:_6,width:_2?null:_3,height:_2?_3:null}],skinImgDir:this.skinImgDir,src:_4,showRollOver:false,showDown:false,backPartName:_5,forwardPartName:_6,mouseDown:function(){this.clickPart=this.inWhichPart();this.setState(isc.StatefulCanvas.STATE_DOWN,this.clickPart)},mouseUp:function(){this.setState(isc.StatefulCanvas.STATE_UP,this.clickPart)},click:function(){var _7=this.clickPart==this.backPartName;if(_7)this.tabSet.scrollBack();else this.tabSet.scrollForward();return false}})}
return this.scroller}else if(_1=="tabPicker"){var _8=this.pickerButtonSize;if(!this.tabPicker){var _9;if(this.symmetricPickerButton){_9=_2?this.pickerButtonVSrc:this.pickerButtonHSrc}else{_9=this.pickerButtonSrc}
this.tabPicker=isc.ImgButton.create({customState:this.symmetricPickerButton?null:this.tabBarPosition,tabSet:this,showRollOver:false,skinImgDir:this.skinImgDir,src:_9,height:(_2?_8:(this.tabBarThickness-this._tabBar.baseLineThickness)),width:(_2?(this.tabBarThickness-this._tabBar.baseLineThickness):_8),click:"this.tabSet.showTabPickerMenu()"})}
...
this.placeControlLayout(_2);if(!this.$8g){var _9=this._tabBar;this.$8g=isc.StretchImg.create({vertical:(_3==isc.Canvas.LEFT||_3==isc.Canvas.RIGHT),_generated:true,skinImgDir:_9.skinImgDir,src:_9.baseLineSrc,capSize:_9.baseLineCapSize,imageType:isc.Img.STRETCH,autoDraw:false});this.addChild(this.$8g)}
