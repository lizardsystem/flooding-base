...
_1.setValue('driver.portNumber',_4);var _5='';if(_3=='dataSource'){if(_2=='oracle')_5='oracle.jdbc.pool.OracleDataSource';if(_2=='mysql')_5='com.mysql.jdbc.jdbc2.optional.MysqlDataSource';if(_2=='sqlserver')_5='com.microsoft.jdbc.sqlserver.SQLServerDriver';if(_2=='postgresql')_5='';if(_2=='db2')_5='COM.ibm.db2.jdbc.DB2DataSource'}
