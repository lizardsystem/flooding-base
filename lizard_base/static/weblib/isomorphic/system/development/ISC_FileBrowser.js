...
,isc.A.setDir=function(_1,_2){if(_1!=this.rootDir&&_1.endsWith("/"))_1=_1.substring(0,_1.length-1);this.logWarn("setDir: "+_1);if(_1.length<this.rootDir.length){isc.say("You cannot go up any further.");return}
if(!_2){if(!this.folderHistory)this.folderHistory=[];this.folderHistory.add(this.currentDir)}
...
,isc.A.fileSelected=function(_1){var _1=this.getFileName(_1);if(_1===false)return;this.confirmAction(_1)}
...
);isc.B._maxIndex=isc.C+8;isc.defineClass("LoadFileDialog","FileBrowser");isc.A=isc.LoadFileDialog.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.title="Load File";isc.A.actionButtonTitle="Load";isc.B.push(isc.A.fileSelected=function(_1){this.loadFile(_1)}
